package qupath.ext.chromogen.ui;

import javafx.fxml.FXML;
import javafx.fxml.FXMLLoader;
import javafx.scene.control.Spinner;
import javafx.scene.layout.VBox;
import qupath.ext.chromogen.ChromogenExtension;
...
public class InterfaceController extends VBox {
    ...
    private InterfaceController() throws IOException {
        ...
        integerOptionSpinner.getValueFactory().valueProperty().bindBidirectional(ChromogenExtension.integerOptionProperty());
